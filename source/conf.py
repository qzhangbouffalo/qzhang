...
#release = 'BL606_BL608_Datasheet_cn'
...
\\usepackage{LastPage}
\\usepackage{titletoc}
\\titlecontents{section}[3.5em]{ \zihao{5}\\vspace{-6pt} }{\contentslabel{1.3em}}{\hspace*{-2em}}{~\\titlerule*[0.8pc]{$.$}~\contentspage}

\\titlecontents{subsection}[6em]{ \zihao{5}\\vspace{-6pt} }{\contentslabel{2.8em}}{\hspace*{-2em}}{~\\titlerule*[0.8pc]{$.$}~\contentspage}

\\titlecontents{subsubsection}[9em]{\zihao{5}\\vspace{-6pt}}{\contentslabel{4em}}{\hspace*{-2em}}{~\\titlerule*[0.8pc]{$.$}~\contentspage}
\\usepackage{chngcntr}
...
{\\raggedright\zihao{5}\heiti\\bfseries\color{MidnightBlue}}
{\\thesubsubsection }
{6pt}
{}
...
\\fancyfoot[L]{\color{black} \\fontsize{9}{9} \selectfont BL602_FAQ}
...
\\fancypagestyle{plain}{
	\\fancyfoot[L]{\color{black} BL602_FAQ}
	\\fancyhead{}
}

\\fancyhead[R]{\makebox[165pt][r]{\\fontsize{15}{15} \selectfont BL602_FAQ}\\vspace{1pt}\hrule height 0pt \\vspace{10pt}}
